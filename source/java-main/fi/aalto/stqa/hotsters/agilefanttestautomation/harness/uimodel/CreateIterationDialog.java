...
public class CreateIterationDialog {
  ...
  // @formatter:off
  /**  */
  private static final String XPATH_CREATE_NEW_ITERATION_DIALOG_TITLE =
      AgilefantUIModel.XPATH_MOST_RECENT_DIALOG +
      "//span[@class='ui-dialog-title' and text()='Create a new iteration']"; //$NON-NLS-1$

  /**  */
  private static final String XPATH_ITERATION_NAME_FIELD = 
      AgilefantUIModel.XPATH_MOST_RECENT_DIALOG +
  ...
  public WebElement dialogTitle() {
    return findElementByXPath(XPATH_CREATE_NEW_ITERATION_DIALOG_TITLE);
  }
   ...
   * @return
   */
  public WebElement iterationNameField() {
    return findElementByXPath(XPATH_ITERATION_NAME_FIELD);
  }
