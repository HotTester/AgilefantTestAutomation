 ...
 */
public class CreateProductsModelHandler extends ModelAPI {

  private final WebDriver driver;
  private final Logger log = Util.setupLogger(CreateProductsModelHandler.class);
   ...
   * @param webDriver
   */
  public CreateProductsModelHandler(
      final File model,
      final boolean efsm,
